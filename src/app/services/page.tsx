      ...
      <div className="container">
        <div className="mb-16 flex flex-col items-start justify-center gap-x-10 gap-y-3 md:mb-20 md:flex-row md:items-center lg:justify-start">
          <div data-aos="fade-up" data-aos-duration="800" className="flex-1">
            <div className="mb-3 inline-block rounded-[72px] bg-[var(--color-overlay)] dark:bg-[var(--color-overlay-dark)]">
            ...
            <h2 className="leading-[1.1]">
              ...
              <span className="text-[var(--color-accent)] italic">Mattress</span> Products
            </h2>
          </div>
          <div className="flex-1 max-md:w-full" data-aos="fade-up" data-aos-duration="800">
            <p className="text-[var(--color-gray-dark)]/70 max-md:text-justify md:max-w-lg md:place-self-end md:text-right">
              ...
              <div className="smallMobile:bottom-[34%] absolute left-6 z-20 sm:bottom-[24%]">
                <div className="flex flex-wrap items-center gap-2 lg:flex-none xl:flex">
                  ...
                  {item.feelOptions.map((feel) => (
                    <div key={feel} className="inline-block rounded-[72px] bg-[var(--color-primary)]">
                      <span className="inline-block px-[10px] py-1.5 text-[8px] font-medium tracking-[0.96px] text-[var(--color-white)] uppercase">
                        {feel}
                      </span>
                    </div>
                  ))}
              ...
              <div>
                ...
                <ul className="mt-3.5 grid max-w-[380px] grid-cols-1 sm:grid-cols-2 [&>*:not(:last-child)]:mb-1">
                  {item.features.map((list) => (
                    <li key={list} className="inline-flex items-center gap-1 text-[var(--color-gray-dark)]/80">
                      <span>
                        <svg
