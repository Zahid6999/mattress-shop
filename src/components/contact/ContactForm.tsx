...
const ContactForm = ({spacing}:PropsType) => {
    ...
    return (
        <section className={`${spacing ?'pt-14 md:pt-16 lg:pt-[88px] xl:pt-[100px] pb-14 md:pb-16 lg:pb-[88px] xl:pb-[100px]' :''}`}>
        ...
        <form
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div className="grid w-full items-center gap-1.5">
                <label htmlFor="firstName" className="text-black text-sm leading-none font-medium">
              ...
              <div className="grid w-full items-center gap-1.5">
                <label htmlFor="lastName" className="text-black text-sm leading-none font-medium">
            ...
            <div className="grid w-full items-center gap-1.5">
              <label
                htmlFor="email"
                className="text-black flex items-center gap-2 text-sm leading-none font-medium">
            ...
            <div className="flex items-center space-x-2">
              ...
              <label htmlFor="terms" className="text-sm leading-none font-medium text-black/30">
                I agree to the <span className="text-black ml-1 underline">privacy policy</span>
              </label>
            </div>
