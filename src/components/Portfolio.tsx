    ...
    <section className="pt-28 pb-14 md:pt-32 md:pb-16 lg:pt-44 lg:pb-[88px] xl:pt-[140px] xl:pb-[100px]">
      <div className="container">
        <div
          ...
          data-aos-offset="-200">
          <div className="inline-block rounded-[52px] bg-[var(--color-primary)]">
            <h2 className="inline-block px-[17px] py-2 text-xs font-medium tracking-[0.96px] text-[var(--color-white)] uppercase">
              WHAT DO WE OFFER?
            </h2>
          </div>
        </div>
